...
import com.example.kaise.msicuw.env.Logger;
import com.example.kaise.msicuw.env.ImageUtils;
import com.example.kaise.msicuw.R;

public abstract class CameraActivitytf extends Activity implements OnImageAvailableListener, Camera.
        PreviewCallback {
  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA) ||
        ...
        Toast.makeText(CameraActivitytf.this,
          ...
          CameraConnectionFragment.newInstance(
              new CameraConnectionFragment.ConnectionCallback() {
                ...
                public void onPreviewSizeChosen(final Size size, final int rotation) {
                  ...
                  CameraActivitytf.this.onPreviewSizeChosen(size, rotation);
                }
              },
              this,
              getLayoutId(),
